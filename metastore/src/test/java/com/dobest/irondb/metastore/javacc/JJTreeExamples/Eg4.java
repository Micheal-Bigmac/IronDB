...
public class Eg4/*@bgen(jjtree)*/implements Eg4TreeConstants, Eg4Constants {/*@bgen(jjtree)*/
...
/** An Integer. */
  ...
  static public void ReInit(java.io.InputStream stream, String encoding) {
    ...
    Eg4TokenManager.ReInit(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
    jj_gen = 0;
  ...
  static private Token jj_consume_token(int kind) throws ParseException {
    ...
    else token = token.next = Eg4TokenManager.getNextToken();
    jj_ntk = -1;
    if (token.kind == kind) {
      jj_gen++;
      return token;
...
/** Get the specific Token. */
  static final public Token getToken(int index) {
    ...
    for (int i = 0; i < index; i++) {
      ...
      else t = t.next = Eg4TokenManager.getNextToken();
    }
    return t;
  }
  ...
  static private int jj_ntk() {
    if ((jj_nt=token.next) == null)
      return (jj_ntk = (token.next= Eg4TokenManager.getNextToken()).kind);
    else
