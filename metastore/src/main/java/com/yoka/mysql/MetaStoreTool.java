...
import com.yoka.irondb.ValidateCheck;
import com.yoka.mysql.IronDbSchemeFactory.NestedScriptParser;
...
public class MetaStoreTool {
    ...
    private final IronDBContext IronDBContext;
...
//        this(System.getenv("HIVE_HOME"), new IronDBContext(), dbType, metaDbType);
        this("E:\\github\\IronDB\\metastore\\src\\main\\resources", com.yoka.irondb.IronDBContext.fromInputStream(MetaStoreTool.class.getResourceAsStream("/IronDB.properties")), dbType, metaDbType);
    }
