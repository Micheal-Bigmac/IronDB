...
package com.dobest.irondb.metastore.lock;
...
public class ZookeeperDistributedLock implements DistributedLock {
    ...
    public static class Factory extends DistributedLockFactory {
        ...
        private static final ConcurrentMap<IronDBContext, CuratorFramework> CACHE = new ConcurrentHashMap<IronDBContext, CuratorFramework>();
        ...
        private static CuratorFramework getZKClient(IronDBContext config) {
        ...
        private static String getZKConnectString(IronDBContext config) {
            // the ZKConnectString should come from IronDBContext, however it is taken from HBase configuration at the moment
        ...
        public Factory() {
            this(IronDBContext.fromInputStream());
        }

        public Factory(IronDBContext config) {
