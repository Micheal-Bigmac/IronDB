...
import com.dobest.irondb.metastore.ValidateCheck;
...
public class MetaStoreTool {
    ...
    private final com.dobest.irondb.metastore.IronDBContext IronDBContext;
...
//        this(System.getenv("HIVE_HOME"), new IronDBContext(), dbType, metaDbType);
        this("E:\\github\\IronDB\\metastore\\src\\main\\resources", com.dobest.irondb.metastore.IronDBContext.fromInputStream(MetaStoreTool.class.getResourceAsStream("/IronDB.properties")), dbType, metaDbType);
    }
